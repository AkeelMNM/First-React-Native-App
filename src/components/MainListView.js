...
const mainListData = [
  {
    id: 'civilizations',
    name: 'Civilization',
    description: 'List of civilizations in the game',
  },
  {
    id: 'units',
    name: 'Units',
    description: 'List of soldier units in the game',
  },
  {
    id: 'structures',
    name: 'Structures',
    description: 'List of building structures in the game',
  },
];
    ...
    <View style={styles.sectionContainer}>
      ...
      <FlatList
        ...
        renderItem={({item, index}) => (
          <TouchableHighlight
            onPress={() => clickResources(item.id)}
            key={index.toString()}
            underlayColor="none">
            <ListItem
              key={index.toString()}
